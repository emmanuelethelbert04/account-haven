...
const steps = [
  {
    ...
    description: 'Find high-quality, verified social media accounts by niche, country, or followers.',
  },
  {
    icon: Wallet,
    step: '02',
    title: 'Choose Payment Method',
    description: 'Pay securely using your wallet balance or direct bank transfer.',
  },
  {
    icon: Zap,
    step: '03',
    title: 'Get Instant Delivery',
    description: 'Wallet payments are delivered instantly. Bank transfers are verified by admin.',
  },
];
